...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .navbar .brand .sun { font-size: 24px; }
...
<body>
    <!-- 导航栏 -->
    <nav class="navbar">
        <div class="brand"><span class="sun">☀️</span> 阳光学情报告</div>
        <div class="nav-links">
    ...
    <footer class="footer">
        ...
        <p>Red-Star Academic Report Platform &copy; <?php echo date('Y'); ?> All rights reserved. <a href="https://beian.miit.gov.cn/" target="_blank" style="color:#666;margin-left:8px">皖ICP备2024037927号-2</a></p>
    </footer>
